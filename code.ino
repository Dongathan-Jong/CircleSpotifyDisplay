...
void checkNewInfo()
{
  ...
  if(lastTrackName != currentTrackName && currentTrackName != "Something went wrong" && currentTrackName != "null" && currentTrackName != "")
  {
  ...
  if(lastArtistName != currentArtistName && currentArtistName != "Something went wrong" && currentArtistName != "null" && currentArtistName != "")
  {
